...
func TestCreateUserFromCSV(t *testing.T) {
	req, err := http.NewRequest("POST", "/creates", nil)
	if err != nil {
		t.Fatal(err)
	}

	w := httptest.NewRecorder()
	handler := http.HandlerFunc(CreateUserFromCSV)
	handler.ServeHTTP(w, req)
	fmt.Println(req)
	...
	expected := `{"id":6,"name":"hazard","balance":500000,"created_time":"9090-08-09 18:14:09","modified_time":""}
	{"id":7,"name":"pogba","balance":480000,"created_time":"9090-08-09 18:14:09","modified_time":""}
	{"id":8,"name":"bruno","balance":600000,"created_time":"9090-08-09 18:14:09","modified_time":""}
	{"id":9,"name":"neymar","balance":460000,"created_time":"9090-08-09 18:14:10","modified_time":""}
	{"id":10,"name":"modric","balance":3000000,"created_time":"9090-08-09 18:14:10","modified_time":""}`
	if strings.TrimSpace(w.Body.String()) != expected {
		t.Errorf("handler returned unexpected bot: got %v want %v", w.Body.String(), expected)
	}
}
...
func TestCreateUser(t *testing.T) {
	...
	var jsonStr = []byte(`{"id":14,"name":"oanh","balance":190000,"created_time":"12:00:00","modified_time":"12:00:00"}`)
	...
	expected := `{"id":14,"name":"oanh","balance":190000,"created_time":"12:00:00",""}`
	if strings.TrimSpace(w.Body.String()) != expected {
